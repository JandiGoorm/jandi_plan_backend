...
public class CommentService {
    ...
    public CommentService(CommunityRepository communityRepository, CommentRepository commentRepository, ValidationUtil validationUtil, ImageService imageService, CommentLikeRepository commentLikeRepository, CommentReportedRepository commentReportedRepository, UserRepository userRepository) {
    ...
    public Page<ParentCommentDTO> getAllComments(Integer postId, int page, int size, String userEmail) {
        ...
        return PaginationService.getPagedData(page, size, totalCount,
                ...
                comment -> new ParentCommentDTO(comment, validationUtil.validateUserExists(comment.getUserId()), imageService,
                        (user != null && commentLikeRepository.findByCommentAndUser(comment, user).isPresent()))
        );
    }
    ...
    public Page<RepliesDTO> getAllReplies(Integer commentId, int page, int size, String userEmail) {
        ...
        return PaginationService.getPagedData(page, size, totalCount,
                ...
                reply -> new RepliesDTO(reply, validationUtil.validateUserExists(reply.getUserId()), imageService,
                        (user != null && commentLikeRepository.findByCommentAndUser(reply, user).isPresent()))
        );
    }
